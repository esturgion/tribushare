...
## Le problème
Quand j'ai besoin d'un bien (biens, livre, outil, jeu ... ) pour un usage temporaire, je veux savoir simplement si un proche le possède, pour pouvoir lui emprunter plutôt que d'emprunter auprès d'un inconnu, louer ou acheter ce bien.
...
- Les utilisateurs ont suffisamment de biens et besoin de biens pour rendre l'application utile

### Risques
- Les utilisateurs préfèrent utiliser d'autres outils qui font déjà partit de leurs habitudes (Whatsapp)
- Le besoin ou l'offre au sein de groupe aussi restraint n'est pas suffisant pour créer une habitude
